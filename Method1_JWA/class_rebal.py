...
def load_data(size=256):
    image_folder = 'F:/mtech/base_implementation/images/train/class'
...
def compute_color_prior(X_ab, size=256, do_plot=False):
...
def smooth_color_prior(size=256, sigma=5, do_plot=False):
...
def compute_prior_factor(size=256, gamma=0.5, alpha=1, do_plot=False):
    file_name = os.path.join(data_dir, "prior_prob_smoothed.npy")
